...
import views.HoGiaDinhManagePanel;
import views.TreEmManagePanel;
import views.HomePagePanel;
import views.HocSinhGioiManagePanel;
import views.QuyTienThuongPanel;
    ...
    public void setView(JPanel jpnItem, JLabel jlbItem, String kind) {
        ...
        switch(kind) {
                case "TrangChu":
                    ...
                    break;
                case "HocSinhGioi":
                    view = new HocSinhGioiManagePanel(this.jfrMain);
                    break;
                case "TreEm":
                    view = new TreEmManagePanel(this.jfrMain);
                    break;
                case "QuyTienThuong":
                    view = new QuyTienThuongPanel(this.jfrMain);
                    break;
                case "HoGiaDinh":
                    view = new HoGiaDinhManagePanel(this.jfrMain);
                    break;
                default:
                    break;
            }
